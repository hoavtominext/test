    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_date_joined', models.DateField(blank=True, null=True)),
                ('authority', models.CharField(max_length=255, null=True)),
                ('is_send_email', models.BooleanField(default=False)),
                ('company', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='user_company', to='Company.Company')),
                ('department', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='user_department', to='Department.Department')),
